...
(function() {
  ...
  // Add this script to your main.js file or include it in a <script> tag in your HTML

document.addEventListener('DOMContentLoaded', function () {
  const themeToggle = document.getElementById('checkbox');
  const body = document.body;

  // Check if the user has a preferred theme (light/dark) stored in localStorage
